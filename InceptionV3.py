    ...
    with tf.variable_scope(scope,'InceptionV3',[inputs]):
        ...
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],
            ...
            with tf.variable_scope('Mixed_6b'):
                ...
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net,128,[1,1],scope='Conv2d_0b_1x1')
                    branch_1 = slim.conv2d(branch_1,128,[1,7],scope='Conv2d_0c_1x7')
            ...
            with tf.variable_scope('Mixed_6c'):
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net,192,[1,1],scope='Conv2d_0a_1x1')
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net,160,[1,1],scope='Conv2d_0b_1x1')
                    branch_1 = slim.conv2d(branch_1,160,[1,7],scope='Conv2d_0c_1x7')
                    branch_1 = slim.conv2d(branch_1,192,[7,1],scope='Conv2d_0c_7x1')
                with tf.variable_scope('Branch_2'):
